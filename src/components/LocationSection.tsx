...
const LocationSection = () => {
  ...
  return (
    <section id="location" className="py-20 md:py-24 relative overflow-hidden bg-background/50">
      <div className="container mx-auto px-6" ref={ref}>
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-display text-gradient-gold text-balance">Our Location</h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="glass-strong rounded-2xl p-8 space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-display text-lg text-primary mb-2">Pearl Bright Beauty Zone & Makeup Studio</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-display text-lg text-primary mb-2">Studio Hours</h4>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-display text-lg text-primary mb-2">Contact</h4>
                  <p className="text-muted-foreground font-body">
                    +91 96863 73707
                  </p>
                </div>
              ...
              <a
                ...
                className="mt-4 inline-flex items-center gap-2 py-3 px-8 bg-gradient-gold text-primary-foreground font-sans-serif text-xs tracking-[0.2em] uppercase rounded-lg hover:scale-[1.02] transition-transform duration-300 gold-glow w-full justify-center"
              >
          ...
          <motion.div
            ...
            className="h-[450px] rounded-2xl overflow-hidden glass-strong border border-border/30 relative"
          >
            <iframe
